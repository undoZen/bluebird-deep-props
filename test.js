...
tape('test description', function (test) {
    ...
    var c = Promise.resolve([0, 1, [[Promise.resolve(2), Promise.resolve([3, Promise.resolve([4, 5])])]]]);
    ...
    resolveDeepProps(c).then(JSON.stringify).then(a => test.strictEqual(a, '[0,1,[[2,[3,[4,5]]]]]'));
    resolveDeepProps(d).then(JSON.stringify).then(b => test.strictEqual(b, '{"a":0,"b":1,"c":{"d":2,"e":{"f":3,"g":{"h":4,"i":5,"j":{"k":6}}}}}'));
